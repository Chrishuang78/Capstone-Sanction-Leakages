# These codes conduct Input-Output analysis, which covers the sections 2.2 and 2.3, and produce results in sections 3.1 & 3.2 (figures 2 ,3, 7)
...
concord_df.to_excel("filtered_file.xlsx", index=False) 
...
for country in ratio_ex2_RU.columns:
    ...
    # If there are no values meeting the criteria, move on to the next column
