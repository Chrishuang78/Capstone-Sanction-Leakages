...
setwd("/Users/huangjinyang/Documents/NYUAD/Fall 24/Capstone/data")

# --------------------------
# Figure 4: Top 5 Exporters to Russia by Product Category (1/2): Coal, Energy Products, Copper, Peat
# --------------------------
...
# --------------------------
# Figure 5: Top 5 Exporters to Russia by Product Category (2/2): Metals, Bitumen, Aluminum
# --------------------------
